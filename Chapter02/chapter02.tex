...
\begin{enumerate}[ref={\thesection.\arabic*}]
    ...
    \begin{prop}[Strong principle of induction]
        ...
        \begin{proof}
            ...
            Since $Q(n)$ is true for all $n\geq m_0$, $P(n)$ is true for all $n\geq m_0$ \cite{bib:StrongInduction}.
        \end{proof}
    \end{prop}
...
\begin{itemize}
    ...
    \begin{defn}[Multiplication of natural numbers]\label{dfn:multiplication}
    ...
    \begin{prop}[Distributive law]\label{prp:distributive}
    ...
    \begin{prop}[Multiplication preserves order]\label{prp:multPreservesOrder}
    ...
    \begin{defn}[Exponentiation of natural numbers]\label{dfn:exponentiation}
    ...
    \begin{lem}[Multiplication is commutative]\label{lem:commutativityMult}
        ...
        \begin{proof}
            ...
            \begin{lem}\label{lem:ntimes0}
                ...
                \begin{proof}
                    We induct on $n$. For the base case $n=0$, Definition \ref{dfn:multiplication} gives us $0\times 0=0$. Suppose inductively that $n\times 0=0$. Then $(n\pplus)\times 0=(n\times 0)+0$ by Definition \ref{dfn:multiplication}, which equals $0+0$ by the inductive hypothesis, which equals $0$. This closes the induction.
                \end{proof}
            \end{lem}
            \begin{lem}\label{lem:ntimesmpplus}
                ...
                \begin{proof}
                    ...
                    \begin{align*}
                        ...
                        &= ((n\times m)+n)+m\tag*{Inductive hypothesis}\\
                        &= ((n\times m)+m)+n\\
            ...
            \begin{align*}
                ...
                &= (m\times n)+m\tag*{Inductive hypothesis}\\
