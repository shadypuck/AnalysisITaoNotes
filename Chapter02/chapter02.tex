...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Vacuous truth}: A conditional or universal statement that is only true because the antecedent cannot be satisfied, e.g., "all cell phones in the room are turned off" is true even if there are no cell phones in the room.
\end{itemize}
